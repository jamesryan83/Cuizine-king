...
exports = module.exports = {
	...
	// App.people_validate_email
	people_validate_email: function (inputs, callback) {
		database.pool.request()
			.input("email", sql.NVarChar, inputs.email)
			.input("verification_token", sql.NVarChar, inputs.verification_token)
			.execute(dbName + "people_validate_email", function (err, result) {
				return resultHandler.handle("people_validate_email", err, result, callback, inputs);
		});
	},
